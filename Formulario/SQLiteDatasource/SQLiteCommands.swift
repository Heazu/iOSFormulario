...
class SQLiteCommands {
    ...
    static let lastName2 = Expression<String>("lastName2")
     ...
     static func insertRow(_ contactValues:Contact) -> Bool? {
         ...
         do {
             try database.run(table.insert(
                ...
                lastName2 <- contactValues.lastName2,
       ...
       static func presentRows() -> [Contact]? {
           ...
           do {
               for contact in try database.prepare(table) {
                   ...
                   let lastName2Value = contact[lastName2]
                   ...
                   print("id \(contact[id]), firstName: \(contact[firstName]), lastName: \(contact[lastName]), lastName2: \(contact[lastName2]), email: \(contact[email]),  phoneNumber: \(contact[phoneNumber]), photo: \(contact[photo])")
               }
           } catch {
